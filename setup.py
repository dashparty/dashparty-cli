...
class install(_install):
    description = "Install dashpartycli-cli and dependencies"
...
setup_options = {
    'name': 'dashparty-cli',
    'version': APP_VERSION,
    'author': 'Dashparty Developers',
    'author_email': 'dev@dashparty.io',
    'maintainer': 'Dashparty Developers',
    'maintainer_email': 'dev@dashparty.io',
    'url': 'http://dashparty.io',
    'license': 'MIT',
    'description': 'Dashparty Protocol Command-Line Interface',
    'long_description': '',
    'keywords': 'dashparty,dash',
    'classifiers': [
    ...
    'download_url': 'https://github.com/Dashparty/dashparty-cli/releases/tag/' + APP_VERSION,
    'provides': ['dashpartycli'],
    ...
    'entry_points': {
        'console_scripts': [
            'dashparty-client = dashpartycli:client_main',
            'dashparty-server = dashpartycli:server_main',
        ]
    },
    'cmdclass': {
        'install': install,
...
if sys.argv[1] == 'py2exe':
    ...
    WIN_DIST_DIR = 'dashparty-cli-win32-{}'.format(APP_VERSION)
