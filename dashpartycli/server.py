...
from dashpartylib.lib import config
from dashpartycli.util import add_config_arguments, bootstrap
from dashpartycli.setup import generate_config_files
from dashpartycli import APP_VERSION

APP_NAME = 'dashparty-server'
...
def main():
    ...
    parser_kickstart.add_argument('--bitcoind-dir', help='Dash Core data directory')
    ...
    log.set_up(log.ROOT_LOGGER, verbose=args.verbose, console_logfilter=os.environ.get('DASHPARTY_LOGGING', None))
    ...
    if args.action in COMMANDS_WITH_DB or args.action in COMMANDS_WITH_CONFIG:
        init_args = dict(database_file=args.database_file,
                                ...
                                force=args.force, verbose=args.verbose, console_logfilter=os.environ.get('DASHPARTY_LOGGING', None),
