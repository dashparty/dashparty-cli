...
from dashpartycli.wallet import bitcoincore, btcwallet
from dashpartylib.lib import config, util, exceptions, script
from dashpartycli.util import api, value_out
...
def WALLET():
    return sys.modules['dashpartycli.wallet.{}'.format(config.WALLET_NAME)]
